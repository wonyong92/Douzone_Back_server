...
public class StaticString {
    ...
    public static final String ATTENDANCE_INFO_STATUS_ABSENT_APPROVED = "승인|이상 근태(결근)";
    public static final String ATTENDANCE_INFO_STATUS_NORMAL_START_EARLY_END_APPROVED = "승인|이상 근태(조기 퇴근)";
    public static final String ATTENDANCE_INFO_STATUS_LATE_START_EARLY_END_APPROVED = "승인|이상 근태(지각, 조기 퇴근)";
    public static final String ATTENDANCE_INFO_STATUS_LATE_START_NORMAL_END_APPROVED = "승인|이상 근태(지각)";
    public static final String ATTENDANCE_INFO_STATUS_NULL_END_APPROVED = "승인|이상 근태(퇴근 정보 없음)";
    public static final String ATTENDANCE_INFO_STATUS_LATE_START_NULL_END_APPROVED = "승인|이상 근태(지각, 퇴근 정보 없음)";
    public static final String ATTENDANCE_INFO_STATUS_NORMAL_START_NULL_END_APPROVED = "승인|이상 근태(퇴근 정보 없음)";
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
