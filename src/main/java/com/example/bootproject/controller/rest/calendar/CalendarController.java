...
public class CalendarController {
    ...
    public ResponseEntity<List<ApiItemToEventDtoForAttendanceInfo>> getAttendanceInfo(@Valid @ModelAttribute CalendarSearchRequestDtoForAttendanceInfo dto, HttpServletRequest req) throws JsonProcessingException {
...
//        return null;
    ...
    @GetMapping("/system/calendar/vacation")
    public ResponseEntity<List<ApiItemToEventDtoForHoliday>> getVacation(@Valid @ModelAttribute CalendarSearchRequestDtoForVacation dto) throws JsonProcessingException {
//        List<ApiItemToEventDtoForHoliday> mappedResult = null;
//        try {
//            mappedResult = calendarService.getEvents(dto);
//        } catch (IOException e) {
//            e.printStackTrace();
//            log.info("공공 캘린더 API에서 데이터 가져오기 실패");
//        } catch (URISyntaxException e) {
