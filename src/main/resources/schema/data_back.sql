...
VALUES ('pending', 'abnormal으로 인한 근태 조정 요청', 1, '2023-11-03 09:10:00', '2023-11-03 18:10:00', '200001011', NOW(), NULL),
       ...
       ('pending', '외출로 인한 근태 조정 요청', 4, '2023-11-06 08:30:00', '2023-11-06 15:30:00', '200001014', NOW(), NULL),
       ...
       ('rejected', '개인 사유에 의한 근태 조정 요청', 6, '2023-11-08 09:00:00', '2023-11-08 17:00:00', '200001016', NOW(),
        '근거 불충분'),
       ('pending', '교통사고로 인한 조정 요청', 7, '2023-11-09 08:45:00', '2023-11-09 17:45:00', '200001018', NOW(), NULL),
       ...
       ('rejected', '예상치 못한 개인 사정으로 인한 조정 요청', 9, '2023-11-11 08:55:00', '2023-11-11 17:55:00', '200001019', NOW(),
        '증빙 자료 미제출'),
       ('pending', '아동 돌봄으로 인한 조정 요청', 10, '2023-11-12 09:05:00', '2023-11-12 18:05:00', '200001021', NOW(), NULL),
       ('pending', 'abnormal으로 인한 근태 조정 요청', 11, '2023-11-04 09:15:00', '2023-11-04 18:00:00', '200001011', NOW(),
        NULL),
       ('pending', '개인 사정으로 인한 조기 퇴근 요청', 12, '2023-11-05 09:00:00', '2023-11-05 16:00:00', '200001011', NOW(), NULL),
       ('pending', '건강 문제로 인한 abnormal 요청', 13, '2023-11-06 00:00:00', '2023-11-06 00:00:00', '200001011', NOW(), NULL),
       ('pending', '외근으로 인한 근태 조정 요청', 14, '2023-11-07 10:00:00', '2023-11-07 15:00:00', '200001011', NOW(), NULL),
       ('pending', '교육 참석으로 인한 반차 요청', 15, '2023-11-08 13:00:00', '2023-11-08 18:00:00', '200001011', NOW(), NULL),
       ('pending', '대중교통 지연으로 인한 abnormal 요청', 16, '2023-11-09 09:30:00', '2023-11-09 18:00:00', '200001011', NOW(),
        NULL),
       ('pending', '가족 행사 참석으로 인한 휴가 요청', 17, '2023-11-10 09:00:00', '2023-11-10 18:00:00', '200001011', NOW(), NULL),
       ('pending', '긴급한 개인 사정으로 인한 abnormal 요청', 18, '2023-11-11 00:00:00', '2023-11-11 00:00:00', '200001011', NOW(),
        NULL),
       ('pending', '야근으로 인한 다음날 abnormal 요청', 19, '2023-11-12 10:00:00', '2023-11-12 18:00:00', '200001011', NOW(),
        NULL),
       ('pending', '전일 야근 회복을 위한 abnormal 요청', 20, '2023-11-13 10:00:00', '2023-11-13 18:00:00', '200001011', NOW(),
        NULL);