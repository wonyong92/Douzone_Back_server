...
values ('a', '200001011', '연차 요청 승인', 3, '2023-11-01', '2023-11-03', '2023-10-01 15:00:00', '사유1');


insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason)
values ('a', '200001011', '연차 요청 승인', 2, '2023-11-06', '2023-11-07', '2023-10-01 15:00:00', '사유1');
...
insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason)
values ('a', '200001012', '연차 요청 승인', 2, '2023-11-02', '2023-11-03', '2023-07-01 15:00:00', '사유1');

insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason)
values ('a', '200001012', '연차 요청 승인', 2, '2023-11-06', '2023-11-07', '2023-07-01 15:00:00', '사유1');

insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason,reason_for_rejection)
values ('a', '200001012', '연차 요청 반려', 1, '2023-11-08', '2023-11-08', '2023-07-01 15:00:00', '사유1','업무 있음');


insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason , reason_for_rejection)
values ('a', '200001012', '연차 요청 반려', 1, '2023-12-12', '2023-11-08', '2023-07-01 15:00:00', '사유1' , '업무 있음');

insert into vacation_request(vacation_category_key, employee_id, vacation_request_state_category_key, vacation_quantity,
                             vacation_start_date, vacation_end_date, vacation_request_time, reason , reason_for_rejection)
values ('a', '200001012', '연차 요청 반려', 1, '2023-12-18', '2023-12-18', '2023-07-01 15:00:00', '사유1','업무 있음');
