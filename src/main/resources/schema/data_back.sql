...
insert into employee values ('testid2','testpw2','name2',false,'2023-01-01');
insert into vacation_category values("a",2);
...
insert into vacation_request(vacation_category_key, employee_id, result, vacation_quantity, vacation_start_time, vacation_end_time, vacation_related_start_time, vacation_related_end_time, vacation_request_time, reason) values("a","testid","승인",1,"2023-02-01","2023-02-10","2023-02-11 09:00:00","2023-02-11 18:00:00","2023-02-01 18:00:00","a");
insert into vacation_request(vacation_category_key, employee_id, result, vacation_quantity, vacation_start_time, vacation_end_time, vacation_related_start_time, vacation_related_end_time, vacation_request_time, reason) values("a","testid","승인",1,"2023-03-01","2023-03-10","2023-03-11 09:00:00","2023-03-11 18:00:00","2023-03-01 18:00:00","a");
insert into vacation_request(vacation_category_key, employee_id, result, vacation_quantity, vacation_start_time, vacation_end_time, vacation_related_start_time, vacation_related_end_time, vacation_request_time, reason) values("a","testid","승인",1,"2023-04-01","2023-04-10","2023-04-11 09:00:00","2023-04-11 18:00:00","2023-04-01 18:00:00","a");
...
insert into vacation_request(vacation_category_key, employee_id, result, vacation_quantity, vacation_start_time, vacation_end_time, vacation_related_start_time, vacation_related_end_time, vacation_request_time, reason,reason_for_rejection) values("a","testid2","반려",1,"2023-01-02","2023-01-11","2023-01-12 09:00:00","2023-01-12 18:00:00","2023-01-02 18:00:00","a","안돼 돌아가세요");
insert into regular_time_adjustment_history(target_date,adjusted_start_time,adjusted_end_time,reason,regular_time_adjustment_time,employee_id) values("2023-01-01","2023-01-01 11:00:00","2023-01-01 12:00:00","이유","2023-01-01 10:00:00","testid");
